...
if recordatorio:
    st.write("Para pasar un CSV a Excel: 1. Abrir con excel 2. Seleccionar la primera columna 3. Datos 4. Texto en columnas 5. Delimitados 6. Coma 7. Avanzados (como en la captura de pantalla)")
